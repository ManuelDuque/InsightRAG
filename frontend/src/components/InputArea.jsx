      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="flex gap-3 items-center">
          ...
          <button
            onClick={handleReset}
            disabled={loading}
            className="flex-shrink-0 p-2.5 bg-gradient-to-br from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white rounded-lg shadow-xl shadow-red-500/30 hover:shadow-red-500/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 group"
